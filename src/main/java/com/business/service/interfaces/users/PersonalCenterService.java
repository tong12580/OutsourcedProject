...
public interface PersonalCenterService {
     ...
     */
    IResult login(UserDTO userDTO, HttpServletRequest request, HttpServletResponse response);
     ...
     */
    IResult logOut(HttpServletRequest request, HttpServletResponse response);

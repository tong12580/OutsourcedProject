...
public enum ResultMessage {
    ...
    STATUS_UPDATE_FAILURE(HttpStatus.INTERNAL_SERVER_ERROR.value(), "修改异常"),
    STATUS_ADD_FAILURE(HttpStatus.INTERNAL_SERVER_ERROR.value(), "添加异常"),
    STATUS_DEL_FAILURE(HttpStatus.INTERNAL_SERVER_ERROR.value(), "删除异常"),
    ...
    INPUT_PARAMETER_IS_EMPTY(HttpStatus.BAD_REQUEST.value(), "参数为空"),

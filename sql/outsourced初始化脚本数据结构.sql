...
CREATE TABLE `user_oauth` (
  ...
  `user_id` int(11) NOT NULL COMMENT '用户id',
  `access_token` varchar(33) COLLATE utf8_unicode_ci NOT NULL COMMENT 'access_token',
  `refresh_token` varchar(33) COLLATE utf8_unicode_ci NOT NULL COMMENT 'refresh_token',
  `scope` int(11) NOT NULL DEFAULT '1' COMMENT '用户权限',
  `token_type` VARCHAR(20) NOT NULL DEFAULT 'example' COMMENT '令牌类型',
  `expires_in` int(11) NOT NULL DEFAULT '6' COMMENT '有效时间(秒)',
